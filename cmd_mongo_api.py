...
class CmdMongo(ApiBase):
    ...
    def bulk_dir(self, dir_path):
        ...
        text_index = [('dir', TEXT)]
        self.create_index("sg_dev_dirs", text_index, name="text", match="partial")
    ...
    def bulk_file(self, file_path):
        ...
        self.create_index("sg_dev_files", text_index, name="text", match="partial")
    ...
    def cmd_update(self, string, types, dirs=[], pre_cmds=[], num=1):
        # 更新命令记录
    ...
    def file_update(self, string, dirs, num=1):
        # 更新文件记录
